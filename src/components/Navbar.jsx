        ...
        <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 transition-all duration-300">
            <div className="max-w-[1400px] mx-auto px-6">
                <div className="flex justify-between h-20 items-center">
                    ...
                    <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-full max-w-md">
                    ...
                    <div className="hidden md:flex items-center gap-6 z-20">
                        <nav className="flex gap-6">
                            <Link to="/events" className="text-sm font-semibold text-gray-600 hover:text-gray-900 transition-colors">Events</Link>
                            <Link to="/dining" className="text-sm font-semibold text-gray-600 hover:text-gray-900 transition-colors">Dining</Link>
                            <Link to="/experiences" className="text-sm font-semibold text-gray-600 hover:text-gray-900 transition-colors">Experiences</Link>
                        </nav>
            ...
            {/* Mobile Menu Overlay */}
            {isMenuOpen && (
                <div className="md:hidden fixed inset-0 top-20 bg-white z-40 p-6 overflow-y-auto">
                    <div className="space-y-6">
                        <Link to="/events" className="block text-xl font-semibold text-gray-900">Events</Link>
                        <Link to="/dining" className="block text-xl font-semibold text-gray-900">Dining</Link>
                        <Link to="/experiences" className="block text-xl font-semibold text-gray-900">Experiences</Link>
